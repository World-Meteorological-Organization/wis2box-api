...
#
###############################################################################
FROM ghcr.io/world-meteorological-organization/dim_eccodes_baseimage:noble_eccodes-2.47
...
RUN pip3 install --no-cache-dir \
    ...
    https://github.com/World-Meteorological-Organization/pywcmp/archive/refs/tags/0.14.4.zip \
...
RUN curl -fsSLO "https://github.com/aptible/supercronic/releases/download/v0.2.48/supercronic-linux-amd64" && \
